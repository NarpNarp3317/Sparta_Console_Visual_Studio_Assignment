...
{
    // ====== Health Potion ======
    Button* buyHpBtn = new Button(0, 1, "Buy_HP_Potion(10G)",
        center_center, { 25,5 }, { -25,-10 }, double_line, White, Gray);
    ...
    // ====== Attack Boost ======
    Button* buyAtkBtn = new Button(0, 1, "Buy_ATK_Boost(15G)",
        center_center, { 25,5 }, { -25,0 }, double_line, White, Gray);
    ...
    // ====== Iron Sword ======
    Button* buySwordBtn = new Button(0, 1, "Buy_Iron_Sword(30G)",
        center_center, { 25,5 }, { -25,10 }, double_line, White, Gray);
    ...
    Button* exitBtn = new Button(0, 1, "Exit_Shop",
        center_center, { 25,5 }, { 0,25 }, double_line, White, Gray);
    ...
    goldBtn = new Button(0, 1, "YOUR_GOLD_:_" + to_string(nowPlayer->getGold()),
        center_center, { 25,5 }, { 0,-12 }, double_line, White, Gray);
    AddButton(goldBtn);
...
void Shop_Layout::updateGoldBtn()
{
    if (!goldBtn) return;
    goldBtn->SetLable("YOUR_GOLD_:_" + to_string(nowPlayer->getGold()));
    goldBtn->UpdateButton();
}